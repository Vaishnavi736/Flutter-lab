...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final Map<String, Widget> pageContents = {
    ...
    'About': Center(
        child:
            Text('This is the About Page.', style: TextStyle(fontSize: 24))),
    'Services': Center(
        child:
            Text('Here are our Services.', style: TextStyle(fontSize: 24))),
    'Contact': Center(
        child: Text('Contact us at example@flutter.dev',
            style: TextStyle(fontSize: 24))),
    'Feedback': Center(
        child:
            Text('Give us your Feedback!', style: TextStyle(fontSize: 24))),
  };
                        ...
                        .map((String choice) => PopupMenuItem<String>(
                              ...
                              child: Center(
                                child: Text(
                                  choice.toUpperCase(),
                                  style: TextStyle(
                                    fontWeight: selectedPage == choice
                                        ? FontWeight.bold
                                        : FontWeight.normal,
                                    color: selectedPage == choice
                                        ? Colors.green[900]
                                        : Colors.red[800],
                                    fontSize: 15,
                                  ),
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/bg.jpg"), // ✅ check pubspec.yaml
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
